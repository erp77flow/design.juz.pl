...
Historia zmian design.juz.pl jest trzymana w pliku `CHANGELOG.md`. Ten widok pokazuje najważniejsze wpisy i zasadę utrzymania.
...
1. Dodaj changeset (`pnpm changeset`).
2. Zmerguj feature PR.
3. Zmerguj automatycznie wystawiony `chore: release packages` PR.
4. Release workflow zbuduje libkę, wystawi tag i GitHub Release.
